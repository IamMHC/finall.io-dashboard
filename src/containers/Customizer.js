  ...
  const getNavStyles = (navStyle) => {
    return (
      <ul className="gx-nav-option gx-list-inline">
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_FIXED)}
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_MINI_SIDEBAR)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_DRAWER)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_NO_HEADER_MINI_SIDEBAR)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_NO_HEADER_EXPANDED_SIDEBAR)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_DEFAULT_HORIZONTAL)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_DARK_HORIZONTAL)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_INSIDE_HEADER_HORIZONTAL)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_BELOW_HEADER)}
            className={`gx-pointer ${
        ...
        <li>
          <span
            onClick={() => navStyleChange(NAV_STYLE_ABOVE_HEADER)}
            className={`gx-pointer ${
